...
export async function retrieveContext(
  ...
  // If Supabase is not configured, return empty context
  if (!supabase) {
    return {
      context: "No specific content found in our database for this query.",
      citations: [],
    };
  }
  ...
  try {
    ...
    // Supabase query failed — return empty context rather than crashing
    return {
      context: "No specific content found in our database for this query.",
      citations: [],
    };
